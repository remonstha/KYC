...
import { updateServicesYouWant } from "../../slices/kycDetails.slice";
import UserDetailsCard from "./UserDetailsCard";
import {
  fetchDebitCardTypeList,
  fetchFrequencyList,
  fetchModeOfDeliveryList,
} from "../../../slices/CentralizedKYC/Dropdowns/thunk";
import { postServices } from "../../../slices/CentralizedKYC/IndividualKYC/thunk";

const ServicesYouWant = () => {
  const dispatch = useDispatch();
  const initialValues = useSelector(
    (state) => state.KycDetails.servicesYouWant
  );

  const servicesFromReducer = useSelector(
    (state) => state.IndKyc?.servicesYouWant
  );
  ...
  const ModeOfDeliveryList = useSelector(
    (state) => state.Dropdown?.ModeOfDelivery
  );
  const DebitCardTypeList = useSelector(
    (state) => state.Dropdown?.DebitCardType
  );
  ...
  const validationSchema = Yup.object().shape({
    frequency: Yup.number()
      .integer("Please enter a valid integer value for frequency")
      .required("Frequency is required"),
    modeOfDelivery: Yup.number()
      .integer("Please enter a valid integer value for mode of delivery")
    ...
    debitCardType: isDebitCardChecked
      ? Yup.number()
          .integer("Please enter a valid integer value for debitcard type")
          .required("debit card type is required")
  ...
  const toggleOnlineBanking = () => {
    setIsOnlineBankingChecked(!isOnlineBankingChecked);
  };
  const toggleMobileBanking = () => {
    setIsMobileBankingChecked(!isMobileBankingChecked);
  };
  const toggleSmsBanking = () => {
    setIsSmsBankingChecked(!isSmsBankingChecked);
  };
  const togglePhonePay = () => {
    setIsPhonePayChecked(!isPhonePayChecked);
  };
  const toggleTransactionAlert = () => {
    setIsTransactionAlertChecked(!isTransactionAlertChecked);
  };
  const toggleMerchantQRChecked = () => {
    setIsMerchantQRChecked(!isMerchantQRChecked);
  };
  ...
  const formik = useFormik({
    ...
    onSubmit: (values) => {
      ...
      const valueToSave = {
        ...
        isStatementPrintNepaliCalendar: values.statementPrint.includes("Nepali Calendar"),
        isStatementPrintEnglishCalendar: values.statementPrint.includes("English Calendar"),
        debitCardType: values.debitCardType,
        serviceToggles: {
          isDebitCardService: values.debitCardService,
          isOnlineBanking: values.onlineBanking,
          isPhonePay: values.phonePay,
          isMobileBanking: values.mobileBanking,
          isTransactionAlert: values.transactionAlert,
          isSMSBanking: values.smsBanking,
          isMerchantQR: values.merchantQR,
        },
        videoKycId: videoKYC?.id,
        id: servicesFromReducer?.id,
      };

      dispatch(postServices(valueToSave));
    },
  });

  //Dropdown options
  const frequencySelect = FrequencyList?.map((item) => ({
    value: item.frequency01uin,
    label: item.frequency01title,
  }));

  const modeOfDelivery = ModeOfDeliveryList?.map((item) => ({
    value: item.mode01uin,
    label: item.mode01title,
  }));

  const debitCardType = DebitCardTypeList?.map((item) => ({
    value: item.debit01uin,
          ...
          <Form className="row" onSubmit={formik.handleSubmit}>
              ...
              <Col md={4}>
                ...
                <div className="d-flex mt-2 align-item-center gap-4">
                  ...
                  <div className="d-flex justify-content-center align-item-center">
                    ...
                    />
                    <label htmlFor="englishCalendar" className="mb-0 ms-2">
                      English Calendar
                    </label>
                  </div>
                </div>
                ...
                <span className="d-flex justify-content-between">
                  ...
                  <div className="form-check form-switch me-5">
                    <input
                      ...
                      style={{
                        boxShadow: "none",
                        backgroundColor: formik.values.debitCardService
                          ? "green"
                          : "red",
                        boxShadow: "none",
                ...
                <h6 className="d-flex justify-content-between">
                  ...
                  <div className="form-check form-switch me-5 mb-3">
                    <input
                      ...
                      style={{
                        boxShadow: "none",
                        backgroundColor: formik.values.onlineBanking
                          ? "green"
                          : "red",
                        boxShadow: "none",
                        backgroundImage: `url("data:image/svg+xml,<svg xmlns='http://www.w3.org/2000/svg' viewBox='-4 -4 8 8'%3e%3ccircle r='3' fill='rgba(255,255,255,1.0)'/></svg>")`,
                ...
                <h6 className="d-flex justify-content-between">
                  ...
                  <div className="form-check form-switch me-5 mb-3">
                    <input
                      ...
                      style={{
                        boxShadow: "none",
                        backgroundColor: formik.values.mobileBanking
                          ? "green"
                          : "red",
                        boxShadow: "none",
                        backgroundImage: `url("data:image/svg+xml,<svg xmlns='http://www.w3.org/2000/svg' viewBox='-4 -4 8 8'%3e%3ccircle r='3' fill='rgba(255,255,255,1.0)'/></svg>")`,
                ...
                <h6 className="d-flex justify-content-between">
                  ...
                  <div className="form-check form-switch me-5 mb-3">
                    <input
                      ...
                      style={{
                        boxShadow: "none",
                        backgroundColor: formik.values.smsBanking
                          ? "green"
                          : "red",
                        boxShadow: "none",
                        backgroundImage: `url("data:image/svg+xml,<svg xmlns='http://www.w3.org/2000/svg' viewBox='-4 -4 8 8'%3e%3ccircle r='3' fill='rgba(255,255,255,1.0)'/></svg>")`,
                ...
                <h6 className="d-flex justify-content-between">
                  ...
                  <div className="form-check form-switch me-5 mb-3">
                    <input
                      ...
                      style={{
                        boxShadow: "none",
                        backgroundColor: formik.values.phonePay
                          ? "green"
                          : "red",
                        boxShadow: "none",
                        backgroundImage: `url("data:image/svg+xml,<svg xmlns='http://www.w3.org/2000/svg' viewBox='-4 -4 8 8'%3e%3ccircle r='3' fill='rgba(255,255,255,1.0)'/></svg>")`,
                ...
                <h6 className="d-flex justify-content-between">
                  ...
                  <div className="form-check form-switch me-5 mb-3">
                    <input
                      ...
                      style={{
                        boxShadow: "none",
                        backgroundColor: formik.values.merchantQR
                          ? "green"
                          : "red",
                        boxShadow: "none",
                        backgroundImage: `url("data:image/svg+xml,<svg xmlns='http://www.w3.org/2000/svg' viewBox='-4 -4 8 8'%3e%3ccircle r='3' fill='rgba(255,255,255,1.0)'/></svg>")`,
            ...
            <div className="d-flex justify-content-between mt-4">
              <Button
                color="light"
                onClick={() =>
                  dispatch(setKycSelectionIndividual("TransactionInfo"))
                }
              >
                Back
              </Button>
...
export default ServicesYouWant;
