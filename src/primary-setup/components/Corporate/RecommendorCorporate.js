...
// export default function RecommenderCorporate() {
...
//       dispatch(setSelection("UploadDocuments"));
//     },
//   });
...
//         <h5 className="mt-1">Recommender</h5>
//       </CardHeader>
...
//               <Button
//                 color="light"
//                 onClick={() => dispatch(setKycSelectionCorporate("location"))}
//               >
//                 Back
//               </Button>
//               <Button color="primary" type="submit" onClick={() => dispatch(setKycSelectionCorporate("uploadDocuments"))}>
//                 Next
//               </Button>
//             </div>
//           </FormGroup>
...
import { updateRecommender } from "../../slices/kycCorporate.slice";
import { setKycSelectionCorporate } from "../../slices/selection.slice";
...
export default function RecommenderCorporate() {
  ...
  const formik = useFormik({
    ...
    onSubmit: (values) => {
      dispatch(updateRecommender(values));
      console.log("values", values);
      dispatch(setKycSelectionCorporate("uploadDocuments"));
    },
  });
