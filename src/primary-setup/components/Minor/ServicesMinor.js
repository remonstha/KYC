...
import { updateServicesMinor } from "../../slices/KycMinor.slice";
...
const ServicesMinor = () => {
  ...
  const initialValues = useSelector(
    (state) => state.KycMinor.servicesMinor
  );
  ...
  const formik = useFormik({
    ...
    onSubmit: (values) => {
      ...
      dispatch(updateServicesMinor(values));
      dispatch(setKycSelectionMinor("RecommenderMinor"))
    },
  });
