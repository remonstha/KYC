...
import { deleteFamilyMemberMinor } from "../../slices/KycMinor.slice";

export default function FamilyDetailsMinor() {
  const initialValues = useSelector((state) => state.KycMinor.familyDetails);
              ...
              <div className="gap-2 d-flex">
                ...
                >
                  <i className="ri-delete-bin-fill"
                    onClick={() => dispatch(deleteFamilyMemberMinor(cellProps.row.index))}
                  ></i>
                </Link>
              </div>
      ...
      <Card className="p-0">
        ...
        <CardFooter>
          <div className="d-flex justify-content-between ">
            ...
            <Button
              color="primary"
              onClick={() => dispatch(setKycSelectionMinor("AddressDetailsMinor"))}
            >
              Next
            </Button>
          </div>
