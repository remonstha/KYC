...
const Cover404 = () => {
    document.title="404 Error Cover | Ants Quality Management System";
                                ...
                                <Col xl={7} lg={8}>
                                    <div className="text-center">
                                        ...
                                        <div className="mt-3">
                                            ...
                                            <Link to="/login" className="btn btn-success"><i className="mdi mdi-home me-1"></i>Back to home</Link>
                                        </div>
                                    </div>
                                </Col>
                            </Row>
